            ...
            <div className="hero place-items-start items-center h-full lg:h-[400px]" style={{ backgroundImage: 'url(https://img.freepik.com/free-photo/top-view-creative-coffee-arrangement_23-2148623221.jpg?w=1380&t=st=1690773432~exp=1690774032~hmac=23b464c848414210c896bb0de7b6e666ccda9c4ba681f382bf6fc4e30230e7aa)' }}>
                ...
                <div className="hero-content text-left text-neutral-content p-20">
                    <div className="flex items-center space-x-10 italic">
                        ...
                        <p className="text-3xl hidden lg:block font-thin w-1/2">Here we are starting a new project to give you guys an opportunity to meet with your favorite chef and attending their classes. And more surprisingly we are giving 10 days free classes.</p>
