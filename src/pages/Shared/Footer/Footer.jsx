...
const Footer = () => {
    return (
        <div>
            <footer className="footer p-10 bg-black text-[#DAA425]">
                <div>
                    ...
                    <p className='pl-24'>Our first priority is our client happiness.</p>
                </div>
                <div className='text-base'>
                    <span className="footer-title opacity-70 text-lg">Address and Contacts</span>
                    <p>85 New Circular Road, Dhaka 1217</p>
                    <p>Email: <a href='https://www.google.com/' className="link link-hover">tastemater@gmail.com</a></p>
                    <p>Helpline: <span>01789576230</span> ,
                        <span> 01533486451</span> ,
                        <span> 01743780098</span>
                    </p>
                    <p>(Available : Sun - Thu, 8:00 AM to 10:00 PM)</p>
                </div>
                <div className='text-base'>
                    <span className="footer-title opacity-70 text-lg">Social</span>
            ...
            <footer className="footer footer-center p-4 bg-[#DAA425] text-black">
                <div>
